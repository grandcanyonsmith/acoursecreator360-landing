        ...
        <div className="md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">The Ultimate All-In-One Software,</span>
            </span>{' '}
            for Course Creators.
          </h2>
          <p className="mt-4 text-lg text-slate-400">
            Built by Course Creators, for Course Creators. Get locked in to our $147/month price for life.
          </p>
        </div>
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          ...
          <Plan
            ...
            features={[
              ...
              '2 Extra CC360 Accounts (3 Total)',
              'UNLIMITED Emails',
              '2,400 Texts Segments /Month (FREE)',
              '(1 Segment = 160 Characters)',
              'SMS credits added each month to your account',
            ]}
          />
        </div>
      </Container>
